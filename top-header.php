    ...
    <nav class="navbar top-navbar navbar-expand-md">
        <div class="navbar-header" data-logobg="skin6">
            ...
            <div class="navbar-brand">
                <a href="index.php">
                    <b class="logo-icon">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/5/56/Lambang_IPDN.png" alt="homepage" class="dark-logo" id="lingkaran" />
                    </b>
                    <span class="logo-text">
                        <img src="assets/mode/images/logo-text-1.png" alt="homepage" class="dark-logo" />
                    </span>
                </a>
            </div>
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <?php
                        if ($_SESSION['image_url']=='NULL') { ?>
                            <img src="assets/img/user/user-13.png" alt="user" class="rounded-circle" width="40"/>   
                            <!-- <img src="assets/img/user/user-13.png" alt="user" class="rounded-circle" width="40"/>    -->
                        <?php }else{ ?>
                            <img src="<?php echo 'assets/img/user/'. $_SESSION['image_url'];?>" alt="user" class="rounded-circle" width="40"/>   
                        <?php } ?>
                        <span class="ml-2 d-none d-lg-inline-block">
                        <span>Hello,</span> 
                        <span class="text-dark"><?php echo $_SESSION['nama_user'];?></span> 
